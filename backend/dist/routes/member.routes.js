...
router.patch("/:id", (0, async_handler_1.asyncHandler)(member_controller_1.updateMember));
router.patch("/:id/status", (0, async_handler_1.asyncHandler)(member_controller_1.updateMemberStatus));
router.delete("/:id", (0, async_handler_1.asyncHandler)(member_controller_1.removeMember));
